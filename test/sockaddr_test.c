...
CTEST_SETUP(addr)
{
  ...
  /* IPv4 */
  data->sockaddr_IPv4_1 =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );

  sockaddr_initFromString( (struct sockaddr*)data->sockaddr_IPv4_1,
                           ipv4_1_str );

  data->sockaddr_IPv4_2 =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
  sockaddr_initFromString( (struct sockaddr*)data->sockaddr_IPv4_2,
                           ipv4_2_str );

  data->sockaddr_IPv4_3 =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
  sockaddr_initFromString( (struct sockaddr*)data->sockaddr_IPv4_3,
                           ipv4_1_str );

  data->sockaddr_IPv4_4 =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
  sockaddr_initFromString( (struct sockaddr*)data->sockaddr_IPv4_4,
                           ipv4_4_str );

  /* IPv6 */
  data->sockaddr_IPv6_1 =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
  sockaddr_initFromString( (struct sockaddr*)data->sockaddr_IPv6_1,
                           ipv6_1_str );

  data->sockaddr_IPv6_2 =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
  sockaddr_initFromString( (struct sockaddr*)data->sockaddr_IPv6_2,
                           ipv6_2_str );

  data->sockaddr_IPv6_3 =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
  sockaddr_initFromString( (struct sockaddr*)data->sockaddr_IPv6_3,
                           ipv6_1_str );

  data->sockaddr_IPv6_4 =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
  sockaddr_initFromString( (struct sockaddr*)data->sockaddr_IPv6_4,
                           ipv6_4_str );

  /* unitialized */
  data->sockaddr_uninit =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );

  /* any */
  data->sockaddr_IPv4_any =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
  sockaddr_initFromString( (struct sockaddr*)data->sockaddr_IPv4_any,
                           ipv4_any_str );

  data->sockaddr_IPv4_any_2 =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
  sockaddr_initAsIPv4Any( (struct sockaddr_in*)data->sockaddr_IPv4_any_2 );

  data->sockaddr_IPv6_any =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
  sockaddr_initFromString( (struct sockaddr*)data->sockaddr_IPv6_any,
                           ipv6_any_str );

  data->sockaddr_IPv6_any_2 =
    (struct sockaddr_storage*)malloc( sizeof(struct sockaddr_storage) );
...
CTEST2(addr, IPv4_init)
{
  ...
  sockaddr_initFromIPv4Int( (struct sockaddr_in*)&a_addr, htonl(a),
                            htons(port) );
  sockaddr_initFromIPv4String( (struct sockaddr_in*)&b_addr,
                               "158.38.48.10:4567" );
  ...
  ASSERT_TRUE( sockaddr_alike( (struct sockaddr*)&a_addr,
                               (struct sockaddr*)&b_addr ) );
  ASSERT_FALSE( sockaddr_alike( (struct sockaddr*)&a_addr,
                                (struct sockaddr*)data->sockaddr_IPv4_1 ) );
  ASSERT_FALSE( sockaddr_initFromIPv4String( (struct sockaddr_in*)&b_addr,
                                             "158.38.48.10.45" ) );
  ASSERT_FALSE( sockaddr_initFromIPv4String( (struct sockaddr_in*)&b_addr,
                                             "158.38.48.10.45.45.67.87:4556" ) );
}
...
CTEST2(addr, IPv6_init)
{
  ...
  ASSERT_TRUE( sockaddr_initFromIPv6String( (struct sockaddr_in6*)&b_addr,
                                            "[2001:470:dc88:2:226:18ff:fe92:6d53]:4567" ) );
  ASSERT_FALSE( sockaddr_alike( (struct sockaddr*)&a_addr,
  ...
  ASSERT_TRUE( sockaddr_alike( (struct sockaddr*)&a_addr,
                               (struct sockaddr*)&b_addr ) );
  ASSERT_FALSE( sockaddr_initFromIPv6String( (struct sockaddr_in6*)&b_addr,
                                             "[2001:470:dc88:2:226:18ff:fe92:6d53" ) );
  ASSERT_FALSE( sockaddr_initFromIPv6String( (struct sockaddr_in6*)&b_addr,
                                             "[2001:470:dc88:2:226:18ff:fe92:6d53:456]" ) );
  ASSERT_FALSE( sockaddr_initFromIPv6String( (struct sockaddr_in6*)&b_addr,
                                             "2001:470:dc88:2:226:18ff:fe92:6d53:4567]:4567" ) );
}
...
CTEST2(addr, IPv4_private)
{
  ...
  sockaddr_initFromString( (struct sockaddr*)&addr_172_h,
                           "172.31.255.255:4534" );
  ...
  sockaddr_initFromString( (struct sockaddr*)&addr_10_h,
                           "10.255.255.255:3459" );
